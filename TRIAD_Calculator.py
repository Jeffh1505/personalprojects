...
h = input("Height above the Earth:" )
Lat = input("Cubesat Latitude: " )
Long = input("Cubesat Longitude: " )
Y = input("Year: " )
M = input("Month: " )
D = input("Day: " )
hr = input("Hour: " )
...
s = input("Second: " )
psi = input("Roll (Phi): " )
theta = input("Pitch (Theta): " )
phi = input("Yaw (Psi): " )
TargetLat = input("Target Latitude: " )
TargetLong = input("Target Longitude: " )
ErrorX = input("Error Percentage in X direction (From 0.0 to 1.0): " )
ErrorY = input("Error Percentage in Y direction (From 0.0 to 1.0): " )
ErrorZ = input("Error Percentage in Z direction (From 0.0 to 1.0): " )
Rearth = 6378.137
