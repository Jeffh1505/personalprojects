...
for i in range(len(data_list)):
    ...
    average_a_list.append(round(a_avg, 2))
    average_error_list.append(round(sigma_avg, 2))

print("Average acceleration values:", average_a_list)
print("Average error values:", average_error_list)
