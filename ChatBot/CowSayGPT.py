...
try:
    chatbot = Chatbot()
    exit = True
    print('List of representations: beavis, cheese ,cow, daemon, dragon, fox, ghostbusters, kitty, meow, miki, milk, octopus, pig, stegosaurus, stimpy, trex, turkey, turtle, tux')
